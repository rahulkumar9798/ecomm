...
class RecyclerProductAdapterbyCategory(val context: Context, val arrProductData: ArrayList<ProductModal>): RecyclerView.Adapter<RecyclerProductAdapterbyCategory.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val userId = (context as CategoryPItemActivity).getuserId()
